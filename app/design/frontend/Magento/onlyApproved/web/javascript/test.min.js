define([
    ...
    $.widget("mage.menu", $.ui.menu, {
        options: { responsive: false, expanded: false, delay: 300 },
        _create: function () {
            var self = this;
            this._super();
        ...
        _assignControls: function () {
            this.controls = { toggleBtn: $('[data-action="toggle-nav"]') };
            return this;
        },
        _listen: function () {
    ...
    $.widget("mage.navigation", $.mage.menu, {
        ...
        setupMoreMenu: function () {
            ...
            this.responsiveMenu = $("<ul>")
                ...
                .menu({ position: { my: "right top", at: "right bottom" } })
        ...
        _responsive: function () {
            ...
            // Remove left property from submenu
            $(".submenu").css("left", "");
        },
    ...
    return { menu: $.mage.menu, navigation: $.mage.navigation };
});
